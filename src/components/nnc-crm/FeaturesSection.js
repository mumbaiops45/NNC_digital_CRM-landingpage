...
const FEATURES = [
  {
    ...
    desc: 'Automatically capture leads from every source — your website contact forms, Facebook and Instagram lead ads, WhatsApp messages, Google Ads, incoming calls, and manual entries. Every lead is instantly logged with source tracking, assigned to the right team member, and queued for follow-up.',
  ...
  },
  {
    ...
    desc: 'See your entire sales operation at a glance with a beautifully designed Kanban-style pipeline board. Drag and drop deals through custom stages that match your exact sales process — from initial enquiry all the way to closed won.',
  ...
  },
  {
    ...
    desc: 'Every contact in your CRM is a complete, living profile. See their full history — every email, every call, every note, every document, every deal — all in one place. For B2B businesses, link contacts to their company accounts.',
  ...
  },
  {
    ...
    desc: 'Set up intelligent automation rules that work for you around the clock. When a new lead comes in, automatically send a welcome email. When a deal has been idle, automatically send a follow-up and create a task for your rep.',
  ...
  },
  {
    ...
    desc: 'Communicate with your leads and customers directly from within NNC CRM — without ever switching tabs. Send and receive emails, sync your Gmail or Outlook inbox, and even send and track WhatsApp messages.',
  ...
  },
  {
    ...
    desc: "Never let your team drop the ball on a follow-up again. NNC CRM's built-in task management system ensures every commitment, every callback, every meeting, and every follow-up is tracked, assigned, and completed on time.",
    bullets: ['Create tasks linked directly to contacts, deals, or accounts','Assign tasks to team members with due dates and priorities','Daily task dashboard — each rep knows exactly what to do today','Overdue task alerts sent via email and in-app notifications','Meeting scheduling with calendar integration'],
  },
  {
    ...
    desc: "NNC CRM's reporting dashboard gives you real-time visibility into your entire sales operation — from the number of new leads this week to your team's conversion rates, average deal size, and revenue forecast for the month.",
  ...
  },
  {
    ...
    desc: "NNC CRM doesn't just help you win customers — it helps you keep them. The built-in support ticketing system lets your team manage customer enquiries, complaints, and requests in a structured way.",
  ...
  },
  {
    ...
    desc: "Turn quotes into invoices without leaving your CRM. NNC CRM's built-in quotation and invoicing module lets your team create professional, branded proposals and send them directly to customers.",
  ...
  },
  {
    ...
    desc: "Your sales team doesn't stop working when they leave the office — and neither should your CRM. The NNC CRM mobile app for iOS and Android gives your team full access to their contacts, deals, tasks, and pipeline on the go.",
